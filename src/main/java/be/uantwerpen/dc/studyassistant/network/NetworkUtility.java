 ...
 */
package be.uantwerpen.dc.studyassistant.network;
...
public class NetworkUtility
{
    ...
    public static String request(URL url, boolean enableCertCheck, boolean enableAuthentication) throws Exception {
